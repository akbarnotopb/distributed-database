...
-->
<!-- build:jsvendor-->
<script type="text/javascript" src="{{url('assets/frontend/js/vendor.js')}}"></script>
<!-- endbuild-->
<!--
...
-->
<!-- build:jsdemodata-->
<script type="text/javascript" src="{{url('assets/frontend/js/demodata.js')}}"></script>
<!-- endbuild-->
<!--
...
-->
<!-- build:jsapp-->
<script type="text/javascript" src="{{url('assets/frontend/js/app.js')}}"></script>
<!-- endbuild-->
<!--
...
-->
<!-- build:jsdemo-->
<script type="text/javascript" src="{{url('assets/frontend/js/demo.js')}}"></script>
<!-- endbuild--><!-- inject:ga  -->
<!-- endinject -->
