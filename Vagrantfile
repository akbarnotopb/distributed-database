Vagrant.configure("2") do |config|
  ...
  config.vm.define "data1" do |data1|
    ...
    data1.vm.network "private_network", ip: "192.168.31.148"
  ...
  config.vm.define "data3" do |data3|
    ...
    data3.vm.network "private_network", ip: "192.168.31.150"
  ...
  config.vm.define "data2" do |data2|
    ...
    data2.vm.network "private_network", ip: "192.168.31.149"
  ...
  config.vm.define "service1" do |service1|
    ...
    service1.vm.network "private_network", ip: "192.168.31.101"
  ...
  config.vm.define "service2" do |service2|
    ...
    service2.vm.network "private_network", ip: "192.168.31.102"
  ...
  config.vm.define "proxy" do |proxy|
    ...
    proxy.vm.network "private_network", ip: "192.168.31.192"
